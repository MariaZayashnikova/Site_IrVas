...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2021-04-01');
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              windowProfile.forEach(function (profile) {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var closeClickOferlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    ...
    if (modalCalcEnd) {
      modalCalcEnd.addEventListener('submit', function (e) {
        e.preventDefault();
        setTimeout(function () {
          modal.style.display = 'none';
          document.body.style.marginRight = "0px";
  ...
  return regeneratorRuntime.async(function postData$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(fetch('http://localhost:3000/dataPersone', {
            method: 'POST',
            headers: {
        ...
        case 2:
          ...
          throw new Error("Error. Status: ".concat(res.status));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(selectorTimer, endTime) {
  var timer = document.querySelector(selectorTimer),
